...
%%%%%%%%%% Calculate training & testing classification accuracy
    ...
    for i = 1 : size(TV.T, 2)
        ...
        if label_index_actual == 2 && label_index_expected == 2
            TN = TN +1;
        end
        if label_index_actual == 1 && label_index_expected == 2
            FN = FN +1;
        end
        if label_index_actual == 2 && label_index_expected == 1
            FP = FP +1;
        end
        if label_index_actual == 1 && label_index_expected == 1
            TP = TP + 1;
        end
    end
